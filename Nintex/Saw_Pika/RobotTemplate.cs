...
namespace Nintex
{
    // Details - FILL IN!!
    // Name: Saw Siew Ching 
    // Email: sawsching@gmail.com
    // Phone Number: 0149238321
    public class Saw_Pika : JuniorRobot
    {
        ...
        public override void OnScannedRobot()
        {
            ...
            // Or ram the bot? //
            // Or run away? //                        
            TurnBackLeft(scannedAngle, 15);
            if (scannedBearing <= 30)
            {
        ...
        public override void OnHitByBullet()
        {
            ...
            // Ouch! You got hit! //
            // Best to move... //
            TurnBackLeft(hitByBulletBearing, 90);
            TurnLeft(50);
