...
namespace Nintex
{
    // Details - FILL IN!!
    // Name: MAK    
    // Email:abdulkhayyum9@gmail.com    
    // Phone Number: 09060884988
    public class Mak_Bot : JuniorRobot
    {        
        public override void Run()
        {
            //Set the color of your robot
            var bodyColor = Color.RosyBrown;  // Body
            var gunColor = Color.Brown; // Gun          
            var radarColor = Color.Red; // Radar
            this.SetColors(bodyColor.ToArgb(), gunColor.ToArgb(), radarColor.ToArgb());             

            // *** Your Code Below ***
            // How your robot moves //
            // Can do a circ, or some odd shape
