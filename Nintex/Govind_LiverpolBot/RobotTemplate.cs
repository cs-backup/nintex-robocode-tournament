...
{
    // Details - FILL IN!!
    // Name: govindiran murukian
    // Email:govin.liverpoll@gmail.com
    // Phone Number: 016-9276279
    public class Govind_LiverpolBot : JuniorRobot
    {        
        ...
        public override void OnHitByBullet()
        {
            ...
            Fire();
            BearGunTo(0);
            TurnRight(HitByBulletBearing + 100);
        }
